...
public class JavassistHelper {
    public static void main(String[] args) throws Exception {
        ...
        CtField keyField = new CtField(pool.getCtClass("java.lang.String"), "key", ctClass);
        keyField.setModifiers(Modifier.PRIVATE);
        ctClass.addField(keyField);

        CtField valueField = new CtField(pool.getCtClass("java.lang.String"), "value", ctClass);
        ...
        ctClass.addMethod(CtNewMethod.getter("getEname", keyField));
        ctClass.addMethod(CtNewMethod.setter("setEname", keyField));
